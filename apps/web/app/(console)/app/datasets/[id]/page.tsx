    ...
    <>
      ...
      {viewMode === "table" ? (
        <DataTable
          ...
          rows={items.map((item) => [
            <div key={item.id}>
              <div className="font-semibold text-[var(--fg)]">{item.filename}</div>
              <div className="mt-1 text-xs text-[var(--muted-soft)]">{item.id.slice(0, 8)}...</div>
            </div>,
            item.media_type,
            ...
            items.map((item) => (
              <article key={item.id} className="console-panel overflow-hidden">
                <div className="console-panel-body">
                  ...
                  <div className="mt-4 font-semibold text-[var(--fg)]">{item.filename}</div>
